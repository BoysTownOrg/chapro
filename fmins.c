#ifndef ARDUINO
// sp_fmins.c - parameter fitting routine using simplex method
...
static double (*variance)(float *pv);
...
static void
    sfinflate(iniv) float iniv[MXNV];
{
    int i, j;
    float d;
...
static void
    sfcentroid(cent) float cent[MXNV];
{
    int i, j;
...
static void
    sfreflect(cent, nxtv) float cent[MXNV],
    nxtv[MXNV];
{
    int i;
...
static void
    sfexpansion(cent, nxtv) float cent[MXNV],
    nxtv[MXNV];
{
    int i;
...
static void
    sfcontraction(cent, nxtv) float cent[MXNV],
    nxtv[MXNV];
{
    int i;
...
// sp_fmins - search for parameters with minimum error
FUNC(int)
sp_fmins(
    float *iniv,
    int npv,
